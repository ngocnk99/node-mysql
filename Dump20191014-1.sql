...
INSERT INTO `med_goods_issue_detail` VALUES (1,1,3,1,1,1,10000,1,1,35,0,_binary '','uoongs'),(2,2,3,21,1,2,100000,1,1,35,1000,_binary '\0','uong');
...
INSERT INTO `med_goods_issue_receipt_detail` VALUES (1,5,1,1,_binary '',1),(2,5,1,2,_binary '',2);
...
INSERT INTO `med_goods_issues` VALUES (1,'Phieuxuat1',32,1,7,_binary '','18E3434','2019-10-14 15:21:22','2019-10-14 15:21:14',27,NULL,35,32,'2019-10-14 15:21:45',_binary '',1,NULL,NULL),(2,'Phieuban02342',32,7,7,_binary '','18E34534','2019-10-14 15:29:32','2019-10-14 15:29:23',26,NULL,35,32,'2019-10-14 15:29:53',_binary '',1,NULL,NULL);
...
INSERT INTO `med_goods_receipt_detail` VALUES (1,1,1,'025',25,25,50,23,'2019-10-14 09:28:44',50,'2019-10-14 09:28:42'),(2,2,1,'1',1,1,2,10000,'2020-10-17 15:02:42',2,'2018-10-02 15:02:39'),(3,3,1,'1',1,1,2,100000,'2020-10-25 15:05:45',2,'2018-08-21 15:05:39'),(4,4,1,'11',1,1,2,100000,'2020-10-17 15:09:02',2,'2019-09-06 15:08:58'),(5,5,3,'12',1,1,2,100000,'2019-10-13 15:16:39',-1,'2019-09-04 15:16:36'),(6,6,3,'so lo 1',1,1,2,10000,'2020-10-17 15:28:56',2,'2019-10-14 15:28:54');
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='Phiếu nhập hàng';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `med_goods_receipts` VALUES (1,'KL20055','Đỗ Minh Thư',6,7,'2019-10-14 09:32:08','2019-10-02 09:27:57',_binary '','025','2019-10-03 09:28:16','null',29,1,5,_binary '',35,1,NULL),(2,'DKL1231','tuyển',1,7,'2019-10-14 15:05:02','2019-10-14 15:02:18',_binary '','18E345353','2019-10-14 15:02:26','null',33,32,9,_binary '',35,1,NULL),(3,'phieu20234','hoan',1,7,'2019-10-14 15:06:01','2019-10-14 15:05:19',_binary '','133E3423','2019-10-14 15:05:29',NULL,33,32,5,_binary '',35,1,NULL),(4,'Phieu231321','Hai',1,7,'2019-10-14 15:09:14','2019-10-14 15:08:26',_binary '','173E3423','2019-10-14 15:08:45',NULL,29,32,5,_binary '',35,1,NULL),(5,'phieu2321','Hai',1,7,'2019-10-14 15:16:52','2019-10-14 15:16:14',_binary '','18E324233','2019-10-14 15:16:25',NULL,33,32,9,_binary '',35,1,NULL),(6,'Phieuban2023','Hoai',1,7,'2019-10-14 15:29:05','2019-10-14 15:28:34',_binary '','16E3443242','2019-10-14 15:28:42',NULL,32,32,5,_binary '',35,1,'01-002001.Phieuban2023');
...
INSERT INTO `med_medicines` VALUES (3,'Golduling','','231313',9,'Tadalafil','VD-14457-11','20mg',3,'viet nam','TCCSh',34,NULL,35,10000,100000,18,'2019-10-14 15:15:42',32,_binary '','DCS000000057049');
...
--
-- Dumping events for database 'core_connect_care'
--

--
-- Dumping routines for database 'core_connect_care'
--
/*!50003 DROP PROCEDURE IF EXISTS `sp_med_goods_issues_getByid` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `sp_med_goods_issues_getByid`(
	in in_goodIssueId bigint
)
BEGIN
	select issue.id,issue.good_issue_code,
    issue.good_issue_invoice_code
    ,issue.issue_code as ma_phieu,
	places.place_code as ma_co_so,
    places.username_of_place as tai_khoan_co_so,
    places.password_of_place as mat_khau_co_so,
    issue.issue_date as ngay_xuat,
    1 as loai_phieu_xuat,
    issue.descriptions as ghi_chu,
    customer.name as ten_co_so_nhan,
	medicine.medicine_code as ma_thuoc,
    medicine.name as ten_thuoc,
    receipt_detail.lotnumber as so_lo,
    receipt_detail.manufacturing_date as ngay_san_xuat,
    receipt_detail.expired_date as han_dung,
    medicine.registration_number as so_dklh,
    issue_detail.quantities as so_luong,
    issue_detail.price as don_gia,
    unit.name as don_vi_tinh,
    issue.invoice_code as ma_hoa_don,
    '' as ma_don_thuoc_quoc_gia,
	issue.issue_date as ngay_ban,
    users.fullname as ho_ten_nguoi_ban,
    customer.name as ho_ten_khach_hang,
    medicine.concentrations as ham_luong,
    issue_detail.duong_dung as duong_dung,
    issue_detail.dose_per_day as lieu_dung,
	medicine.registration_number as so_dang_ky,
    issue_detail.quantities * issue_detail.price as thanh_tien,
    (case when  issue_detail.is_retail = true then 1 else issue_detail.coefficient end ) as ty_le_quy_doi
 from med_goods_issues as issue
inner join med_goods_issue_detail as issue_detail on issue_detail.goods_issues_id = issue.id
inner join med_units as unit on unit.id = issue_detail.units_id
inner join med_medicines as medicine on medicine.id = issue_detail.medicines_id
inner join med_goods_issue_receipt_detail as issue_receipt_detail on issue_receipt_detail.goods_issue_detail_id = issue_detail.id
inner join med_goods_receipt_detail as receipt_detail on receipt_detail.id = issue_receipt_detail.goods_receipt_detail_id
inner join places on places.id = issue.places_id
inner join users on users.id = issue.users_seller_id
inner join med_customers as customer on customer.id = issue.customers_id
where issue.id=in_goodIssueId;
...
/*!50003 DROP PROCEDURE IF EXISTS `sp_med_goods_issues_insert` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `sp_med_goods_issues_insert`(
	in in_goodsIssues nvarchar(4000),
    out out_output int
    -- 1: thành công
    -- -1: Số lượng trong kho không đủ để bán
    -- 0: lỗi chung
)
BEGIN
	declare in_issue_code VARCHAR(100);
    declare in_users_seller_id bigint;
    declare in_payment_methods_id bigint;
    declare in_warehouses_id bigint;
    declare in_debit bit;
    declare in_invoice_code VARCHAR(100);
    declare in_invoice_date datetime;
    declare in_issues_date datetime;
    declare in_descriptions VARCHAR(200);
	declare in_customers_id bigint;
    declare in_is_retail bit;
    declare in_users_creator_id bigint;
    declare in_places_id bigint;
    declare in_status bit;

    -- detail goods_receipts
    declare in_goods_issues_id bigint;
    declare in_medicines_id bigint;
    declare in_units_id bigint;
    declare in_quantities bigint;
    declare in_price bigint;
    declare in_dose_per_day bigint;
    declare in_quantities_per_time bigint;
    declare in_discounts bigint;
    declare in_retailQuantities bigint;
    declare in_wholeSaleQuantities bigint;
     declare in_flag bigint;
	declare in_duongDung varchar(200);
     
    declare in_length_goods_isssues_detail bigint;
	DECLARE _index BIGINT UNSIGNED DEFAULT 0;
    
    declare i_goods_receipt_detail_id bigint;
    declare i_goods_issue_detail_id bigint;
    declare i_quantites bigint;
    declare i_coefficient bigint;
    ...
    set in_length_goods_isssues_detail= JSON_LENGTH(JSON_EXTRACT(in_goodsIssues,'$.goodsIssues.detail'));
	if(in_length_goods_isssues_detail=0)
    then
		set out_output=0;
		ROLLBACK;
    else 
    
		set in_issue_code = JSON_UNQUOTE(JSON_EXTRACT(in_goodsIssues,'$.goodsIssues.issueCode'));
		set in_users_seller_id = JSON_UNQUOTE(JSON_EXTRACT(in_goodsIssues,'$.goodsIssues.usersSellerId'));
		set in_payment_methods_id = JSON_UNQUOTE(JSON_EXTRACT(in_goodsIssues,'$.goodsIssues.paymentMethodsId'));
		set in_warehouses_id = JSON_UNQUOTE(JSON_EXTRACT(in_goodsIssues,'$.goodsIssues.warehousesId'));
		set in_issues_date = STR_TO_DATE(JSON_UNQUOTE(JSON_EXTRACT(in_goodsIssues,'$.goodsIssues.issueDate')),'%Y-%m-%d %T');
		set in_debit = IF(JSON_UNQUOTE(JSON_EXTRACT(in_goodsIssues,'$.goodsIssues.debit'))='true',true,false);
		set in_invoice_code = JSON_UNQUOTE(JSON_EXTRACT(in_goodsIssues,'$.goodsIssues.invoiceCode'));
		set in_invoice_date = STR_TO_DATE(JSON_UNQUOTE(JSON_EXTRACT(in_goodsIssues,'$.goodsIssues.invoiceDate')),'%Y-%m-%d %T');
		set in_descriptions = JSON_UNQUOTE(JSON_EXTRACT(in_goodsIssues,'$.goodsIssues.descriptions'));
		set in_customers_id = JSON_UNQUOTE(JSON_EXTRACT(in_goodsIssues,'$.goodsIssues.customersId'));
		set in_users_creator_id = JSON_UNQUOTE(JSON_EXTRACT(in_goodsIssues,'$.goodsIssues.usersCreatorId'));
		set in_places_id = JSON_UNQUOTE(JSON_EXTRACT(in_goodsIssues,'$.goodsIssues.placesId'));
		set in_status = IF(JSON_UNQUOTE(JSON_EXTRACT(in_goodsIssues,'$.goodsIssues.status'))='true',true,false);
		
		insert into med_goods_issues(issue_code,users_seller_id,payment_methods_id,
		warehouses_id,create_date,debit,invoice_code,invoice_date,issue_date,
		customers_id,descriptions,places_id,users_creator_id,status)
		values(in_issue_code,in_users_seller_id,in_payment_methods_id,
		in_warehouses_id,now(),in_debit,in_invoice_code,in_invoice_date,in_issues_date,
		in_customers_id,in_descriptions,in_places_id,in_users_creator_id,in_status);
		set in_goods_issues_id= LAST_INSERT_ID();
		
		label1:WHILE _index < in_length_goods_isssues_detail DO
			set in_is_retail =  IF(JSON_UNQUOTE(JSON_EXTRACT(in_goodsIssues,concat('$.goodsIssues.detail[',_index,'].isRetail')))='true',true,false);
			set in_medicines_id= JSON_UNQUOTE(JSON_EXTRACT(in_goodsIssues,concat('$.goodsIssues.detail[',_index,'].medicinesId')));
			set in_units_id= JSON_UNQUOTE(JSON_EXTRACT(in_goodsIssues,concat('$.goodsIssues.detail[',_index,'].unitsId')));
			set in_quantities= JSON_UNQUOTE(JSON_EXTRACT(in_goodsIssues,concat('$.goodsIssues.detail[',_index,'].quantities')));
			set in_price= JSON_UNQUOTE(JSON_EXTRACT(in_goodsIssues,concat('$.goodsIssues.detail[',_index,'].price')));
			set in_dose_per_day= JSON_UNQUOTE(JSON_EXTRACT(in_goodsIssues,concat('$.goodsIssues.detail[',_index,'].dosePerDay')));
			set in_discounts= JSON_UNQUOTE(JSON_EXTRACT(in_goodsIssues,concat('$.goodsIssues.detail[',_index,'].discounts')));
			set in_quantities_per_time= JSON_UNQUOTE(JSON_EXTRACT(in_goodsIssues,concat('$.goodsIssues.detail[',_index,'].quantitiesPerTime')));
			set in_retailQuantities= JSON_UNQUOTE(JSON_EXTRACT(in_goodsIssues,concat('$.goodsIssues.detail[',_index,'].retailQuantities')));
			set in_wholeSaleQuantities= JSON_UNQUOTE(JSON_EXTRACT(in_goodsIssues,concat('$.goodsIssues.detail[',_index,'].wholeSaleQuantities')));
			-- set in_flag = JSON_UNQUOTE(JSON_EXTRACT(in_goodsIssues,concat('$.goodsIssues.detail[',_index,'].flag')));
			set in_duongDung = JSON_UNQUOTE(JSON_EXTRACT(in_goodsIssues,concat('$.goodsIssues.detail[',_index,'].duongDung')));
            ...
            ifnull(
				(
				select 
					case when in_is_retail= true 
                    then
						if((in_quantities) <= sum(receipt_detail.quantities_in_stock),1,1)
					else
						if((in_quantities) <= (sum(receipt_detail.quantities_in_stock)/(sum(receipt_detail.retail_quantities)/sum(receipt_detail.quantities_received))),1,1)
                    end
				from med_goods_receipts as receipts
					inner join med_goods_receipt_detail as receipt_detail
						on receipt_detail.goods_receipts_id = receipts.id
				where receipt_detail.medicines_id = in_medicines_id
				and receipt_detail.quantities_in_stock >0
                and receipts.warehouses_id = in_warehouses_id
            )
             ,1)
            )
            then
				set out_output=1;
				insert into med_goods_issue_detail(goods_issues_id,medicines_id,units_id,
				quantities,price,dose_per_day,quantities_per_time,places_id,discounts,
                is_retail,coefficient,duong_dung)
				-- values(in_goods_issues_id,in_medicines_id,in_units_id,
				-- in_quantities,in_price,in_dose_per_day,in_quantities_per_time,
                 --   in_places_id,in_discounts,in_is_retail,in_retailQuantities/in_wholeSaleQuantities);
				SELECT in_goods_issues_id,in_medicines_id,in_units_id,
					in_quantities,in_price,in_dose_per_day,in_quantities_per_time,
                    in_places_id,in_discounts,in_is_retail,
                    (
						case when in_is_retail= true 
							then 1 else packages.quantities
						end
                    ),in_duongDung
                    FROM med_medicines as medicines
					inner join med_packages packages on packages.id= medicines.packages_id
				where medicines.id = in_medicines_id;
				set i_goods_issue_detail_id = LAST_INSERT_ID();

				while in_quantities >0 do
					
					select 
							CASE when in_is_retail = true then
								if(in_quantities<=ifnull(receipt_detail.quantities_in_stock,0),in_quantities,ifnull(receipt_detail.quantities_in_stock,0))
							else
							  if(in_quantities <=ifnull((receipt_detail.quantities_in_stock/(receipt_detail.retail_quantities/receipt_detail.quantities_received)
								),0),in_quantities,ifnull((receipt_detail.quantities_in_stock/(receipt_detail.retail_quantities/receipt_detail.quantities_received)
								),0))
							end
					,receipt_detail.id, 
							CASE when in_is_retail = false 
                            then 
								(receipt_detail.retail_quantities/receipt_detail.quantities_received) 
							else 1
                            end
                    into i_quantites,i_goods_receipt_detail_id,i_coefficient
					from med_goods_receipts as receipts
						inner join med_goods_receipt_detail as receipt_detail
							on receipt_detail.goods_receipts_id = receipts.id
					where receipt_detail.medicines_id = in_medicines_id
					and receipt_detail.quantities_in_stock >0
					order by receipt_detail.expired_date asc
					limit 1 ;
					
					insert into med_goods_issue_receipt_detail(goods_receipt_detail_id,
						quantites,goods_issue_detail_id,is_debit,coefficient)
						values(i_goods_receipt_detail_id,i_quantites,i_goods_issue_detail_id,in_debit,
                        i_coefficient
                        );
					
					
					update med_goods_receipt_detail 
                    set quantities_in_stock = quantities_in_stock - 
                    (
						case when in_is_retail = false then i_quantites * i_coefficient 
                        else i_quantites
                        end
                    )
					where id = i_goods_receipt_detail_id;
					
					set in_quantities = in_quantities -i_quantites;
					
				END WHILE; 
            else
				-- select in_quantities;
				set out_output=-111;
				ROLLBACK;
				LEAVE label1;
            end if;
...
call sp_med_goods_issues_getByid(in_goods_issues_id);
	end if;
	 COMMIT;
END ;;
DELIMITER ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_med_goods_issues_update` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `sp_med_goods_issues_update`(
	in in_goodsIssues nvarchar(4000),
    out out_output int
)
BEGIN
    ...
    -- detail goods_receipts
    declare in_goods_issues_id bigint;
    declare in_goods_issues_detail_id bigint;
    declare in_medicines_id bigint;
    declare in_units_id bigint;
    declare in_quantities bigint;
    declare in_price bigint;
    ...
    declare in_whosale_quantities_old bigint;
    declare in_retail_quantities_old bigint;
    ...
    then
		...
		ROLLBACK;
		 ...
		 set in_goods_issues_id = JSON_UNQUOTE(JSON_EXTRACT(in_goodsIssues,'$.goodsIssues.id'));
		 set in_issue_code = JSON_UNQUOTE(JSON_EXTRACT(in_goodsIssues,'$.goodsIssues.issueCode'));
		 set in_users_seller_id = JSON_UNQUOTE(JSON_EXTRACT(in_goodsIssues,'$.goodsIssues.usersSellerId'));
		 set in_payment_methods_id = JSON_UNQUOTE(JSON_EXTRACT(in_goodsIssues,'$.goodsIssues.paymentMethodsId'));
		set in_warehouses_id = JSON_UNQUOTE(JSON_EXTRACT(in_goodsIssues,'$.goodsIssues.warehousesId'));
		...
		update med_goods_issues set
		issue_code = in_issue_code,
		users_seller_id = in_users_seller_id,
		payment_methods_id = in_payment_methods_id,
		warehouses_id = in_warehouses_id,
		debit =in_debit,
		invoice_code = in_invoice_code,
		invoice_date = in_invoice_date,
		issue_date = in_issues_date,
		customers_id = in_customers_id,
		descriptions = in_descriptions,
		places_id = in_places_id,
		status = in_status
		where id=in_goods_issues_id;
	
		WHILE _index < in_length_goods_isssues_detail DO
			set out_output=1;
			set in_is_retail =  IF(JSON_UNQUOTE(JSON_EXTRACT(in_goodsIssues,concat('$.goodsIssues.detail[',_index,'].isRetail')))='true',true,false);
			set in_goods_issues_detail_id = JSON_UNQUOTE(JSON_EXTRACT(in_goodsIssues,concat('$.goodsIssues.detail[',_index,'].id')));
			set in_medicines_id= JSON_UNQUOTE(JSON_EXTRACT(in_goodsIssues,concat('$.goodsIssues.detail[',_index,'].medicinesId')));
			set in_units_id= JSON_UNQUOTE(JSON_EXTRACT(in_goodsIssues,concat('$.goodsIssues.detail[',_index,'].unitsId')));
			set in_quantities= JSON_UNQUOTE(JSON_EXTRACT(in_goodsIssues,concat('$.goodsIssues.detail[',_index,'].quantities')));
			set in_price= JSON_UNQUOTE(JSON_EXTRACT(in_goodsIssues,concat('$.goodsIssues.detail[',_index,'].price')));
			...
			set in_flag = JSON_UNQUOTE(JSON_EXTRACT(in_goodsIssues,concat('$.goodsIssues.detail[',_index,'].flag')));
			set in_duongDung = JSON_UNQUOTE(JSON_EXTRACT(in_goodsIssues,concat('$.goodsIssues.detail[',_index,'].duongDung')));
			set i_goods_issue_detail_id =	in_goods_issues_detail_id;
           -- select in_flag;
           if(in_status = true)
           then 
				...
				if(in_flag = 0)
				then
					set in_whosale_quantities_old = IFNULL((select  quantities
													from med_goods_issue_detail where id = in_goods_issues_detail_id and is_retail=false),0);
					set in_retail_quantities_old = IFNULL((select quantities 
													from med_goods_issue_detail where id = in_goods_issues_detail_id and  is_retail=true),0);
					...
					1 = ifnull(
						...
						select 
							case when in_is_retail= true 
							then
								if((in_quantities -in_retail_quantities_old) <= sum(receipt_detail.quantities_in_stock),1,0)
							else
								if((in_quantities -in_whosale_quantities_old) <= sum(receipt_detail.quantities_in_stock/(receipt_detail.retail_quantities/receipt_detail.quantities_received)),1,0)
							end
						from med_goods_receipts as receipts
							inner join med_goods_receipt_detail as receipt_detail
								on receipt_detail.goods_receipts_id = receipts.id
						where receipt_detail.medicines_id = in_medicines_id
						and 
                        -- receipt_detail.quantities_in_stock >0
						-- and 
                        receipts.warehouses_id = in_warehouses_id
					),0)
					)
					then
						
						update med_goods_issue_detail set
							goods_issues_id=in_goods_issues_id,
							medicines_id=in_medicines_id,
							units_id =in_units_id,
							quantities =in_quantities,
							price =in_price,
							dose_per_day = in_dose_per_day,
							quantities_per_time =in_quantities_per_time,
							discounts = in_discounts,
                            duong_dung = in_duongDung
						where id=in_goods_issues_detail_id;
                        
						update med_goods_receipt_detail as tbl1,
							med_goods_issue_receipt_detail as tbl2 set
							tbl1.quantities_in_stock = tbl1.quantities_in_stock + tbl2.quantites * tbl2.coefficient
                        where tbl1.id= tbl2.goods_receipt_detail_id
                        and tbl2.goods_issue_detail_id = in_goods_issues_detail_id
                        and tbl1.id >0
                        ;
                        
                        
                        
						delete from med_goods_issue_receipt_detail 
                        where goods_issue_detail_id = in_goods_issues_detail_id
                        and id >0;
				...
				then
                    ...
                    delete from med_goods_issue_receipt_detail where goods_issue_detail_id=in_goods_issues_detail_id;
					delete from med_goods_issue_detail 	where id=in_goods_issues_detail_id;
				...
				then
					...
					in_quantities,in_price,in_dose_per_day,in_quantities_per_time,
                    in_places_id,in_discounts,in_is_retail,
                    (case when in_is_retail= true then packages.wholesale_quantities else 1 end),
                    in_duongDung
                    FROM med_medicines as medicines
					inner join med_packages packages on packages.id= medicines.packages_id
				where medicines.id = in_medicines_id;
				...
				then
					insert into med_goods_issue_detail(goods_issues_id,medicines_id,units_id,
					quantities,price,dose_per_day,quantities_per_time,places_id,discounts,is_retail)
					values(in_goods_issues_id,in_medicines_id,in_units_id,
						in_quantities,in_price,in_dose_per_day,in_quantities_per_time,in_places_id,in_discounts,in_is_retail);
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_med_goods_receipts_insert` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `sp_med_goods_receipts_insert`(
	in in_goodsReceipts nvarchar(4000),
    out out_output int
)
BEGIN

	declare in_receipt_code VARCHAR(100);
    declare in_shipper_name VARCHAR(100);
    declare in_payment_methods_id bigint;
    declare in_warehouses_id bigint;
    declare in_date_receipt datetime;
    declare in_debit bit;
    declare in_invoice_code VARCHAR(100);
    declare in_invoice_date datetime;
    declare in_descriptions VARCHAR(200);
    declare in_users_recipient_id bigint;
    declare in_users_creator_id bigint;
    declare in_suppliers_id bigint;
    declare in_places_id bigint;
    declare in_status bit;
    declare med_goods_receipts_id bigint;
    -- detail goods_receipts
    declare in_goods_receipts_id bigint;
    declare in_medicines_id bigint;
    declare in_lotnumber nvarchar(100);
    declare in_quantities_request bigint;
    declare in_quantities_received bigint;
    declare in_price bigint;
    declare in_expired_date datetime;
    declare in_retail_price bigint;
    declare in_wholesale_price bigint;
    declare in_retail_quantities bigint;
    declare in_manufacturingDate datetime;
    
    declare in_length_goods_receipts_detail bigint;
	DECLARE _index BIGINT UNSIGNED DEFAULT 0;
	...
	START TRANSACTION;
    set in_length_goods_receipts_detail= JSON_LENGTH(JSON_EXTRACT(in_goodsReceipts,'$.goodsReceipts.detail'));
    if(in_length_goods_receipts_detail=0)
    then
		set out_output=0;
		ROLLBACK;
    else 
		set in_receipt_code = JSON_UNQUOTE(JSON_EXTRACT(in_goodsReceipts,'$.goodsReceipts.receiptCode'));
		set in_shipper_name = JSON_UNQUOTE(JSON_EXTRACT(in_goodsReceipts,'$.goodsReceipts.shipperName'));
		set in_payment_methods_id = JSON_UNQUOTE(JSON_EXTRACT(in_goodsReceipts,'$.goodsReceipts.paymentMethodsId'));
		set in_warehouses_id = JSON_UNQUOTE(JSON_EXTRACT(in_goodsReceipts,'$.goodsReceipts.warehousesId'));
		set in_date_receipt = STR_TO_DATE(JSON_UNQUOTE(JSON_EXTRACT(in_goodsReceipts,'$.goodsReceipts.dateReceipt')),'%Y-%m-%d %T');
		set in_debit = IF(JSON_UNQUOTE(JSON_EXTRACT(in_goodsReceipts,'$.goodsReceipts.debit'))='true',true,false);
		set in_invoice_code = JSON_UNQUOTE(JSON_EXTRACT(in_goodsReceipts,'$.goodsReceipts.invoiceCode'));
		set in_invoice_date = STR_TO_DATE(JSON_UNQUOTE(JSON_EXTRACT(in_goodsReceipts,'$.goodsReceipts.invoiceDate')),'%Y-%m-%d %T');
		set in_descriptions = JSON_UNQUOTE(JSON_EXTRACT(in_goodsReceipts,'$.goodsReceipts.descriptions'));
		set in_users_recipient_id = JSON_UNQUOTE(JSON_EXTRACT(in_goodsReceipts,'$.goodsReceipts.usersRecipientId'));
		set in_users_creator_id = JSON_UNQUOTE(JSON_EXTRACT(in_goodsReceipts,'$.goodsReceipts.usersCreatorId'));
		set in_suppliers_id = JSON_UNQUOTE(JSON_EXTRACT(in_goodsReceipts,'$.goodsReceipts.suppliersId'));
		set in_places_id = JSON_UNQUOTE(JSON_EXTRACT(in_goodsReceipts,'$.goodsReceipts.placesId'));
		set in_status = IF(JSON_UNQUOTE(JSON_EXTRACT(in_goodsReceipts,'$.goodsReceipts.status'))='true',true,false);
		insert into med_goods_receipts(receipt_code,shipper_name,payment_methods_id,
		warehouses_id,create_date,date_receipt,debit,invoice_code,invoice_date,
		descriptions,users_recipient_id,users_creator_id,suppliers_id,places_id,status)
		values(in_receipt_code,in_shipper_name,in_payment_methods_id,
		in_warehouses_id,now(),in_date_receipt,in_debit,in_invoice_code,in_invoice_date,
		in_descriptions,in_users_recipient_id,in_users_creator_id,in_suppliers_id,in_places_id,in_status);
		set med_goods_receipts_id=LAST_INSERT_ID();
		
		WHILE _index < in_length_goods_receipts_detail DO
			set in_medicines_id= JSON_UNQUOTE(JSON_EXTRACT(in_goodsReceipts,concat('$.goodsReceipts.detail[',_index,'].medicinesId')));
			set in_lotnumber= JSON_UNQUOTE(JSON_EXTRACT(in_goodsReceipts,concat('$.goodsReceipts.detail[',_index,'].lotNumber')));
			set in_quantities_request= JSON_UNQUOTE(JSON_EXTRACT(in_goodsReceipts,concat('$.goodsReceipts.detail[',_index,'].quantitiesRequest')));
			set in_quantities_received= JSON_UNQUOTE(JSON_EXTRACT(in_goodsReceipts,concat('$.goodsReceipts.detail[',_index,'].quantitiesReceived')));
			set in_price= JSON_UNQUOTE(JSON_EXTRACT(in_goodsReceipts,concat('$.goodsReceipts.detail[',_index,'].price')));
			set in_expired_date= STR_TO_DATE(JSON_UNQUOTE(JSON_EXTRACT(in_goodsReceipts,concat('$.goodsReceipts.detail[',_index,'].expiredDate'))),'%Y-%m-%d %T');
			set in_retail_price= JSON_UNQUOTE(JSON_EXTRACT(in_goodsReceipts,concat('$.goodsReceipts.detail[',_index,'].retailPrice')));
			set in_wholesale_price= JSON_UNQUOTE(JSON_EXTRACT(in_goodsReceipts,concat('$.goodsReceipts.detail[',_index,'].wholesalePrice')));
			set in_retail_quantities = JSON_UNQUOTE(JSON_EXTRACT(in_goodsReceipts,concat('$.goodsReceipts.detail[',_index,'].retailQuantities')));
			set in_manufacturingDate = STR_TO_DATE(JSON_UNQUOTE(JSON_EXTRACT(in_goodsReceipts,concat('$.goodsReceipts.detail[',_index,'].manufacturingDate'))),'%Y-%m-%d %T');
			insert into med_goods_receipt_detail(goods_receipts_id,medicines_id,lotnumber,
				quantities_request,quantities_received,price,expired_date,retail_quantities
				,quantities_in_stock,manufacturing_date)
			values(med_goods_receipts_id,in_medicines_id,in_lotnumber,
				in_quantities_request,in_quantities_received,in_price,in_expired_date,in_retail_quantities
				,in_retail_quantities,in_manufacturingDate);
			
			update med_medicines set 
				retail_price = in_retail_price,wholesale_price=in_wholesale_price
			where id= in_medicines_id;
			
			/*if exists(select id from med_warehouses_details
				where medicines_id = in_medicines_id 
					and places_id = in_places_id)
			then 
				update med_warehouses_details set whosale_quantities=whosale_quantities+in_quantities_received,
					retail_quantities =retail_quantities+ in_retail_quantities
				where medicines_id = in_medicines_id 
					and places_id = in_places_id and id>0;
			else
				insert into med_warehouses_details(places_id,medicines_id,
				whosale_quantities,retail_quantities)
				values(in_places_id,in_medicines_id,in_quantities_received,in_retail_quantities);
			end if;*/
			SET _index := _index + 1;
		END WHILE;
        select med_goods_receipts_id as id;
		set out_output=1;
	 end if;
	 COMMIT;
END ;;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_med_goods_receipts_update` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `sp_med_goods_receipts_update`(
	in in_goodsReceipts nvarchar(4000),
    out out_output int -- 0: lỗi chung
      -- 1: thành công
      -- -1: Lỗi sửa số lượng kho bị âm
)
BEGIN
    ...
    declare in_check_receipt_detail bigint;
   ...
   /* DECLARE EXIT HANDLER FOR SQLEXCEPTION, SQLWARNING
    ...
    then
		...
		set in_id = JSON_UNQUOTE(JSON_EXTRACT(in_goodsReceipts,'$.goodsReceipts.id'));
		set in_receipt_code = JSON_UNQUOTE(JSON_EXTRACT(in_goodsReceipts,'$.goodsReceipts.receiptCode'));
		set in_shipper_name = JSON_UNQUOTE(JSON_EXTRACT(in_goodsReceipts,'$.goodsReceipts.shipperName'));
		set in_payment_methods_id = JSON_UNQUOTE(JSON_EXTRACT(in_goodsReceipts,'$.goodsReceipts.paymentMethodsId'));
		set in_warehouses_id = JSON_UNQUOTE(JSON_EXTRACT(in_goodsReceipts,'$.goodsReceipts.warehousesId'));
		...
		if exists (select * from med_goods_receipts where id=in_id)
		then
			set out_output=1;
			update med_goods_receipts set 
				receipt_code= in_receipt_code,
				shipper_name= in_shipper_name,
				payment_methods_id = in_payment_methods_id,
				warehouses_id = in_warehouses_id,
				create_date = now(),
				date_receipt = in_date_receipt,
				debit = in_debit,
				invoice_code = in_invoice_code,
				invoice_date = in_invoice_date,
				descriptions = in_descriptions,
				users_recipient_id = in_users_recipient_id,
			   -- users_creator_id = in_users_creator_id,
				suppliers_id = in_suppliers_id,
				status = in_status
				where id= in_id;
				
			 WHILE _index < in_length_goods_receipts_detail DO
				set in_detail_id= JSON_UNQUOTE(JSON_EXTRACT(in_goodsReceipts,concat('$.goodsReceipts.detail[',_index,'].id')));
				set in_medicines_id= JSON_UNQUOTE(JSON_EXTRACT(in_goodsReceipts,concat('$.goodsReceipts.detail[',_index,'].medicinesId')));
				set in_lotnumber= JSON_UNQUOTE(JSON_EXTRACT(in_goodsReceipts,concat('$.goodsReceipts.detail[',_index,'].lotNumber')));
				set in_quantities_request= JSON_UNQUOTE(JSON_EXTRACT(in_goodsReceipts,concat('$.goodsReceipts.detail[',_index,'].quantitiesRequest')));
				set in_quantities_received= JSON_UNQUOTE(JSON_EXTRACT(in_goodsReceipts,concat('$.goodsReceipts.detail[',_index,'].quantitiesReceived')));
				...
				set in_wholesale_price= JSON_UNQUOTE(JSON_EXTRACT(in_goodsReceipts,concat('$.goodsReceipts.detail[',_index,'].wholesalePrice')));
				set in_retail_quantities = JSON_UNQUOTE(JSON_EXTRACT(in_goodsReceipts,concat('$.goodsReceipts.detail[',_index,'].retailQuantities')));
				set in_flag = JSON_UNQUOTE(JSON_EXTRACT(in_goodsReceipts,concat('$.goodsReceipts.detail[',_index,'].flag')));
                if(in_status = true)
                then
					if(in_flag = 0)
					then
						set in_whosale_quantities_old = (select quantities_received 
												from med_goods_receipt_detail where id = in_detail_id);
						set in_retail_quantities_old = (select retail_quantities 
												from med_goods_receipt_detail where id = in_detail_id);
                                                
                        set in_check_receipt_detail = ifnull((select if(in_quantities_received <= sum(quantites),1,0) 
							from med_goods_issue_receipt_detail where goods_receipt_detail_id=in_detail_id),1);
						if (in_check_receipt_detail = 1
						)
						then 
                        
                        
							update med_goods_receipt_detail set
							-- goods_receipts_id = 
							medicines_id = in_medicines_id,
							lotnumber = in_lotnumber,
							quantities_request = in_quantities_request,
							quantities_received= in_quantities_received,
							price = in_price,
							expired_date = in_expired_date,
							quantities_in_stock = quantities_in_stock +in_retail_quantities -  in_retail_quantities_old
							where id = in_detail_id;
					...
					then
						if exists (select *
							from med_goods_issue_receipt_detail where goods_receipt_detail_id=in_detail_id)
						then
							set out_output=-1;
							ROLLBACK;
                        else
							delete from med_goods_receipt_detail where id=in_detail_id;
						end if;
					...
					then
						insert into med_goods_receipt_detail(goods_receipts_id,medicines_id,lotnumber,
							quantities_request,quantities_received,price,expired_date,retail_quantities,
							quantities_in_stock)
						values(in_id,in_medicines_id,in_lotnumber,
							in_quantities_request,in_quantities_received,in_price,in_expired_date,
							in_retail_quantities,in_retail_quantities);
					...
					then
						...
						then 
							update med_goods_receipt_detail set
								...
								price = in_price,
								expired_date = in_expired_date,
								quantities_in_stock = in_quantities_received +in_retail_quantities -in_retail_quantities_old
							where id = in_detail_id;
						else
							set out_output=-1;
							ROLLBACK;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_med_report_places_byCustomer` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `sp_med_report_places_byCustomer`(
	in in_lstCustomerid nvarchar(4000),
	in in_dtfrom datetime,
    in in_dtto datetime,
	in in_pageindex INT,
	in in_pagesize INT,
	out out_total_paid bigint,
	out out_total_debts bigint,
	out out_total_money bigint,
    out out_total_profit bigint,
	out out_row_count bigint
)
BEGIN
    ...
    drop temporary table if exists t_byCustomerID;
	create temporary table t_byCustomerID( txt text );
	insert into t_byCustomerID values(in_lstCustomerid);
    
    drop temporary table if exists temp_ByCustomerid;
	create temporary table temp_ByCustomerid( val nvarchar(50) );
	set @sql = concat("insert into temp_ByCustomerid (val) values ('", replace(( select group_concat(distinct txt) as data from t_byCustomerID), ",", "'),('"),"');");
	prepare stmt1 from @sql;
	execute stmt1;
	select distinct(val) from temp_ByCustomerid;
    if(in_lstCustomerid ='0')
    then
		DROP TEMPORARY TABLE IF EXISTS temp_customer;
		CREATE TEMPORARY TABLE temp_customer
		(
		select 
				u.id,u.name,((issue_detail.price*issue_receipt_detail.quantites)-issue_detail.discounts) as total,issues.debit,
				(((issue_detail.price*issue_detail.quantities)-issue_detail.discounts)-
					(
					issue_detail.quantities*(case when issue_detail.is_retail =false
                    then receipt_detail.price
                    else ROUND(receipt_detail.quantities_received*receipt_detail.price/receipt_detail.retail_quantities,0) end
					)
                )
                )
                as 'profit'
			 
			from med_goods_issues as issues
			inner join med_goods_issue_detail as issue_detail on issue_detail.goods_issues_id =  issues.id
			 inner join med_goods_issue_receipt_detail as issue_receipt_detail on issue_receipt_detail.goods_issue_detail_id=issue_detail.id
            inner join med_goods_receipt_detail as receipt_detail on receipt_detail.id = issue_receipt_detail.goods_receipt_detail_id
            inner join med_customers as u on u.id = issues.customers_id
			inner join med_group_customers group_cus on group_cus.id = u.group_customers_id
			where date_format(issues.issue_date,'%Y%m%d') >= date_format(in_dtfrom,'%Y%m%d') 
			and date_format(issues.issue_date,'%Y%m%d') <= date_format(in_dtto,'%Y%m%d')
			-- and exists(select * from temp_ByCustomerid where temp_ByCustomerid.val=issues.customers_id)
			and group_cus.id <> 1
			);
	else 
		DROP TEMPORARY TABLE IF EXISTS temp_customer;
		...
		(
		select 
				u.id,u.name,((issue_detail.price*issue_detail.quantities)-issue_detail.discounts) as total,issues.debit,
				(((issue_detail.price*issue_detail.quantities)-issue_detail.discounts)-
					(
					issue_detail.quantities*(case when issue_detail.is_retail =false
                    then receipt_detail.price
    ...
    DROP TEMPORARY TABLE IF EXISTS temp_report_byCustomer;
	CREATE TEMPORARY TABLE temp_report_byCustomer
	(
	select id,name,COALESCE(SUM(
					CASE 
						WHEN debit=0
						THEN total
						ELSE 0 
	...
	group by id,name
     ...
     SET out_total_paid = (
			SELECT sum(paid) FROM temp_report_byCustomer
		);
	SET out_total_debts = (
			SELECT sum(debts) FROM temp_report_byCustomer
		);
	SET out_total_money = (
			SELECT sum(totalMoney) FROM temp_report_byCustomer
		);
    SET out_total_profit = (
			SELECT sum(profit) FROM temp_report_byCustomer 
		);
	SET out_row_count = (SELECT COUNT(*) FROM temp_report_byCustomer);
    
	SELECT	*
		FROM (
			SELECT  
			*, (@row_number := @row_number + 1) AS rownum FROM temp_report_byCustomer
            order by temp_report_byCustomer.name asc
		) t
		WHERE t.rownum >= start_page and t.rownum <= end_page  ;
		
    
    drop TEMPORARY table temp_report_byCustomer;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_med_report_places_byDoctor` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `sp_med_report_places_byDoctor`(
	in in_lstCustomerid nvarchar(4000),
	in in_dtfrom datetime,
    in in_dtto datetime,
	in in_pageindex INT,
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_med_report_places_byMedicines` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `sp_med_report_places_byMedicines`(
	in in_lstmedicinesid nvarchar(4000),
	in in_dtfrom datetime,
    in in_dtto datetime,
	in in_pageindex INT,
	in in_pagesize INT,
...
BEGIN
    ...
    drop temporary table if exists t_byMedicinesID;
	create temporary table t_byMedicinesID( txt text );
	insert into t_byMedicinesID values(in_lstmedicinesid);
    
    drop temporary table if exists tempMedicinesid;
	create temporary table tempMedicinesid( val nvarchar(50) );
	set @sql = concat("insert into tempMedicinesid (val) values ('", replace(( select group_concat(distinct txt) as data from t_byMedicinesID), ",", "'),('"),"');");
	prepare stmt1 from @sql;
	execute stmt1;
	select distinct(val) from tempMedicinesid;
    if(in_lstmedicinesid ='0')
    then
		DROP TEMPORARY TABLE IF EXISTS temp_Medicines;
		CREATE TEMPORARY TABLE temp_Medicines
		(
		select 
				medicines.id,medicines.name,((issue_detail.price*issue_detail.quantities)-issue_detail.discounts) as total,issues.debit,
					(
                    (issue_detail.price*issue_detail.quantities)-issue_detail.discounts)-
					(
					issue_detail.quantities*(case when issue_detail.is_retail =false
			...
			inner join med_goods_issue_receipt_detail as issue_receipt_detail on issue_receipt_detail.goods_issue_detail_id=issue_detail.id
            inner join med_goods_receipt_detail as receipt_detail on receipt_detail.id = issue_receipt_detail.goods_receipt_detail_id
            inner join med_medicines as medicines on medicines.id = issue_detail.medicines_id
			where date_format(issues.issue_date,'%Y%m%d') >= date_format(in_dtfrom,'%Y%m%d') 
			and date_format(issues.issue_date,'%Y%m%d') <= date_format(in_dtto,'%Y%m%d')
			-- and exists(select * from tempMedicinesid where tempMedicinesid.val=issue_detail.medicines_id)
			);
	else 
		DROP TEMPORARY TABLE IF EXISTS temp_Medicines;
		CREATE TEMPORARY TABLE temp_Medicines
    ...
    DROP TEMPORARY TABLE IF EXISTS temp_report_byMedicines;
	CREATE TEMPORARY TABLE temp_report_byMedicines
	(
	select id,name,COALESCE(SUM(
					CASE 
						WHEN debit=0
	...
	group by id,name
     ...
     SET out_total_paid = (
			SELECT sum(paid) FROM temp_report_byMedicines
		);
	SET out_total_debts = (
			SELECT sum(debts) FROM temp_report_byMedicines
		);
	SET out_total_money = (
			SELECT sum(totalMoney) FROM temp_report_byMedicines
		);
    SET out_total_profit = (
			SELECT sum(profit) FROM temp_report_byMedicines 
		);
	SET out_row_count = (SELECT COUNT(*) FROM temp_report_byMedicines);
    
	SELECT	*
		FROM (
			SELECT  
			*, (@row_number := @row_number + 1) AS rownum FROM temp_report_byMedicines
            order by temp_report_byMedicines.name asc
		) t
		WHERE t.rownum >= start_page and t.rownum <= end_page  ;
		
    
    drop TEMPORARY table temp_report_byMedicines;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_med_report_places_byMedicine_ExpiredDate` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `sp_med_report_places_byMedicine_ExpiredDate`(
	in in_lstplaceid bigint,
    in in_lstwarehouses nvarchar(4000),
    in in_lstgroupmedicines nvarchar(4000),
	in in_lstmedicines nvarchar(4000),
	in in_pageindex INT,
	in in_pagesize INT,
	out out_total_money bigint,
	out out_row_count bigint
...
BEGIN
    ...
    drop temporary table if exists t_warehouses_ExpiredDate;
	create temporary table t_warehouses_ExpiredDate( txt text );
	insert into t_warehouses_ExpiredDate values(in_lstwarehouses);
    
    drop temporary table if exists temp_warehouseid_ExpiredDate;
	create temporary table temp_warehouseid_ExpiredDate( val nvarchar(50) );
	set @sql = concat("insert into temp_warehouseid_ExpiredDate (val) values ('", replace(( select group_concat(distinct txt) as data from t_warehouses_ExpiredDate), ",", "'),('"),"');");
	prepare stmt1 from @sql;
	execute stmt1;
	-- select distinct(val) from temp_warehouseid_ExpiredDate;
    
    drop temporary table if exists t_groupmedicines_ExpiredDate;
	create temporary table t_groupmedicines_ExpiredDate( txt text );
	insert into t_groupmedicines_ExpiredDate values(in_lstgroupmedicines);
    
    drop temporary table if exists temp_groupmedicines_ExpiredDate;
	create temporary table temp_groupmedicines_ExpiredDate( val nvarchar(50) );
	set @sql2 = concat("insert into temp_groupmedicines_ExpiredDate (val) values ('", replace(( select group_concat(distinct txt) as data from t_groupmedicines_ExpiredDate), ",", "'),('"),"');");
	prepare stmt2 from @sql2;
	execute stmt2;
    
	drop temporary table if exists t_medicines_ExpiredDate;
	create temporary table t_medicines_ExpiredDate( txt text );
	insert into t_medicines_ExpiredDate values(in_lstmedicines);
    
    drop temporary table if exists temp_medicines_ExpiredDate;
	create temporary table temp_medicines_ExpiredDate( val nvarchar(50) );
	set @sql3 = concat("insert into temp_medicines_ExpiredDate (val) values ('", replace(( select group_concat(distinct txt) as data from t_medicines_ExpiredDate), ",", "'),('"),"');");
	prepare stmt3 from @sql3;
	execute stmt3;
    
	if ( in_lstwarehouses ='0')
    then 
		DROP TEMPORARY TABLE IF EXISTS temp_medicine_ExpiredDate;
		CREATE TEMPORARY TABLE temp_medicine_ExpiredDate
		(
			select group_medicine.name as groupMedicineName,medicine.barcode,medicine.name,unit.name as unitName,receipt_detail.lotnumber,receipt_detail.expired_date,
				receipt_detail.quantities_in_stock,round((receipt_detail.quantities_received*receipt_detail.price/receipt_detail.retail_quantities),1) as price,
				round((receipt_detail.quantities_received*receipt_detail.price/receipt_detail.retail_quantities),0) *receipt_detail.quantities_in_stock as totalMoney 
				 from med_goods_receipts as receipt
				inner join med_goods_receipt_detail as receipt_detail on receipt_detail.goods_receipts_id = receipt.id
				inner join med_medicines as medicine on medicine.id = receipt_detail.medicines_id
                inner join med_group_medicines as group_medicine on group_medicine.id = medicine.group_medicines_id
				inner join med_packages as package on package.id = medicine.packages_id
				inner join med_units as unit on unit.id=package.units_id
				where receipt.places_id = in_lstplaceid
                -- and medicine.status=1
                and ((
					exists(select * from temp_groupmedicines_ExpiredDate where temp_groupmedicines_ExpiredDate.val=group_medicine.id)
					and in_lstgroupmedicines <>'0'
                ) or in_lstgroupmedicines='0'
                )
                and ((
                 exists(select * from temp_medicines_ExpiredDate where temp_medicines_ExpiredDate.val=medicine.id)
				and in_lstgroupmedicines <>'0' 
           )
			or in_lstmedicines='0'
           )
        );
	else
		DROP TEMPORARY TABLE IF EXISTS temp_medicine_ExpiredDate;
		CREATE TEMPORARY TABLE temp_medicine_ExpiredDate
		(
			select group_medicine.name as groupMedicineName,medicine.barcode,medicine.name,unit.name as unitName,receipt_detail.lotnumber,
           receipt_detail.expired_date as expired_date,
				receipt_detail.quantities_in_stock,round((receipt_detail.quantities_received*receipt_detail.price/receipt_detail.retail_quantities),1) as price,
				round((receipt_detail.quantities_received*receipt_detail.price/receipt_detail.retail_quantities),1) *receipt_detail.quantities_in_stock as totalMoney 
				 from med_goods_receipts as receipt
				inner join med_goods_receipt_detail as receipt_detail on receipt_detail.goods_receipts_id = receipt.id
				inner join med_medicines as medicine on medicine.id = receipt_detail.medicines_id
				inner join med_group_medicines as group_medicine on group_medicine.id = medicine.group_medicines_id
				...
				where receipt.places_id = in_lstplaceid
				-- and medicine.status=1
                and exists(select * from temp_warehouseid_ExpiredDate where temp_warehouseid_ExpiredDate.val=receipt.warehouses_id)
				  and ((
					exists(select * from temp_groupmedicines_ExpiredDate where temp_groupmedicines_ExpiredDate.val=group_medicine.id)
					and in_lstgroupmedicines <>'0'
                ) or in_lstgroupmedicines='0'
    ...
    DROP TEMPORARY TABLE IF EXISTS temp_report_medicine_ExpiredDate;
		CREATE TEMPORARY TABLE temp_report_medicine_ExpiredDate
		(
			select groupMedicineName,barcode,name,unitName,
            lotnumber,expired_date,
			sum(price) as price,
			sum(totalMoney) as totalMoney 
			 from temp_medicine_ExpiredDate
             group by name,expired_date,groupMedicineName,barcode,lotnumber,unitName
		);
    
	SET out_total_money = (
			SELECT sum(ifnull(totalMoney,0)) FROM temp_report_medicine_ExpiredDate
		);
  
	SET out_row_count = (SELECT COUNT(*) FROM temp_report_medicine_ExpiredDate);
    
	SELECT	*
		FROM (
			SELECT  
			*, (@row_number := @row_number + 1) AS rownum FROM temp_report_medicine_ExpiredDate
            order by temp_report_medicine_ExpiredDate.expired_date desc
		) t
		WHERE t.rownum >= start_page and t.rownum <= end_page  ;
		
    
   -- drop TEMPORARY table temp_medicine_ExpiredDate;
   -- drop TEMPORARY table temp_warehouseid_ExpiredDate;
   -- drop TEMPORARY table t_medicine_ExpiredDate;
	-- drop TEMPORARY table temp_report_medicine_ExpiredDate;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_med_report_places_byMedicine_OutofStock` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `sp_med_report_places_byMedicine_OutofStock`(
	in in_lstplaceid bigint,
    in in_lstwarehouses nvarchar(4000),
	in in_lstgroupmedicines nvarchar(4000),
    in in_alert_number_in_stock bigint,
	in in_pageindex INT,
	in in_pagesize INT,
	out out_row_count bigint
)
BEGIN
    ...
    drop temporary table if exists t_medicine_OutofStock;
	create temporary table t_medicine_OutofStock( txt text );
	insert into t_medicine_OutofStock values(in_lstwarehouses);
    
    drop temporary table if exists temp_warehouseid_OutofStock;
	create temporary table temp_warehouseid_OutofStock( val nvarchar(50) );
	set @sql = concat("insert into temp_warehouseid_OutofStock (val) values ('", replace(( select group_concat(distinct txt) as data from t_medicine_OutofStock), ",", "'),('"),"');");
	prepare stmt1 from @sql;
	execute stmt1;
	-- select distinct(val) from temp_warehouseid_OutofStock;
    
     drop temporary table if exists t_groupmedicines_OutofStock;
	create temporary table t_groupmedicines_OutofStock( txt text );
	insert into t_groupmedicines_OutofStock values(in_lstgroupmedicines);
    
    drop temporary table if exists temp_groupmedicines_OutofStock;
	create temporary table temp_groupmedicines_OutofStock( val nvarchar(50) );
	set @sql2 = concat("insert into temp_groupmedicines_OutofStock (val) values ('", replace(( select group_concat(distinct txt) as data from t_groupmedicines_OutofStock), ",", "'),('"),"');");
	prepare stmt2 from @sql2;
	execute stmt2;
	...
	if ( in_lstwarehouses ='0')
    then 
		DROP TEMPORARY TABLE IF EXISTS temp_medicine_OutofStock;
		CREATE TEMPORARY TABLE temp_medicine_OutofStock
		(
			select group_medicine.name as groupMedicineName,medicine.barcode,
            medicine.name,in_alert_number_in_stock,
				receipt_detail.quantities_in_stock
				 from med_goods_receipts as receipt
				inner join med_goods_receipt_detail as receipt_detail on receipt_detail.goods_receipts_id = receipt.id
				inner join med_medicines as medicine on medicine.id = receipt_detail.medicines_id
                inner join med_group_medicines as group_medicine on group_medicine.id = medicine.group_medicines_id
				where receipt.places_id = in_lstplaceid
                  -- and medicine.status=1
                and receipt_detail.quantities_in_stock < in_alert_number_in_stock
                 and ((
					exists(select * from temp_groupmedicines_OutofStock 
                    where temp_groupmedicines_OutofStock.val=group_medicine.id)
					and in_lstgroupmedicines <>'0'
                ) or in_lstgroupmedicines='0'
                )
		);
		...
		(
            ...
            medicine.name,in_alert_number_in_stock,
				...
				where receipt.places_id = in_lstplaceid
                 -- and medicine.status=1
                and receipt_detail.quantities_in_stock < in_alert_number_in_stock
                and exists(select * from temp_warehouseid_OutofStock where temp_warehouseid_OutofStock.val=receipt.warehouses_id)
                 and ((
					exists(select * from temp_groupmedicines_OutofStock 
                    where temp_groupmedicines_OutofStock.val=group_medicine.id)
					and in_lstgroupmedicines <>'0'
	...
	SET out_row_count = (SELECT COUNT(*) FROM temp_medicine_OutofStock);
    
	SELECT	*
		FROM (
			SELECT  
			*, (@row_number := @row_number + 1) AS rownum FROM temp_medicine_OutofStock
            order by temp_medicine_OutofStock.quantities_in_stock desc
		) t
		WHERE t.rownum >= start_page and t.rownum <= end_page  ;
		
    
    drop TEMPORARY table temp_medicine_OutofStock;
    drop TEMPORARY table temp_warehouseid_OutofStock;
    drop TEMPORARY table t_medicine_OutofStock;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_med_report_places_byStaff` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `sp_med_report_places_byStaff`(
	in in_lstuserid nvarchar(4000),
	in in_dtfrom datetime,
    in in_dtto datetime,
	in in_pageindex INT,
	in in_pagesize INT,
...
BEGIN
    ...
    drop temporary table if exists t_byUserID;
	create temporary table t_byUserID( txt text );
	insert into t_byUserID values(in_lstuserid);
    
    drop temporary table if exists temp_ByStaffid;
	create temporary table temp_ByStaffid( val nvarchar(50) );
	set @sql = concat("insert into temp_ByStaffid (val) values ('", replace(( select group_concat(distinct txt) as data from t_byUserID), ",", "'),('"),"');");
	prepare stmt1 from @sql;
	execute stmt1;
	select distinct(val) from temp_ByStaffid;
    if ( in_lstuserid ='0')
    then 
		...
		(
		select 
				u.id,u.fullname,((issue_detail.price*issue_receipt_detail.quantites)-issue_detail.discounts) as total,issues.debit,
			(((issue_detail.price*issue_detail.quantities)-issue_detail.discounts)-
					(
					issue_detail.quantities*(case when issue_detail.is_retail =false
                    then receipt_detail.price
			...
			from med_goods_issues as issues
			inner join users as u on u.id = issues.users_seller_id
			inner join med_goods_issue_detail as issue_detail on issue_detail.goods_issues_id =  issues.id
			 inner join med_goods_issue_receipt_detail as issue_receipt_detail on issue_receipt_detail.goods_issue_detail_id=issue_detail.id
            inner join med_goods_receipt_detail as receipt_detail on receipt_detail.id = issue_receipt_detail.goods_receipt_detail_id
            where date_format(issues.issue_date,'%Y%m%d') >= date_format(in_dtfrom,'%Y%m%d') 
			and date_format(issues.issue_date,'%Y%m%d') <= date_format(in_dtto,'%Y%m%d')
			-- and exists(select * from temp where temp.val=issues.users_seller_id)
			);
	else
		DROP TEMPORARY TABLE IF EXISTS temp_staff;
		CREATE TEMPORARY TABLE temp_staff
		(
		select 
				u.id,u.fullname,((issue_detail.price*issue_detail.quantities)-issue_detail.discounts) as total,issues.debit,
				(((issue_detail.price*issue_detail.quantities)-issue_detail.discounts)-
					(
					issue_detail.quantities*(case when issue_detail.is_retail =false
                    then receipt_detail.price
            ...
            where date_format(issues.issue_date,'%Y%m%d') >= date_format(in_dtfrom,'%Y%m%d') 
			and date_format(issues.issue_date,'%Y%m%d') <= date_format(in_dtto,'%Y%m%d')
			and exists(select * from temp_ByStaffid where temp_ByStaffid.val=issues.users_seller_id)
			);
    end if;
    DROP TEMPORARY TABLE IF EXISTS temp_report_bystaff;
	CREATE TEMPORARY TABLE temp_report_bystaff
	(
	select id,fullname,COALESCE(SUM(
					CASE 
						WHEN debit=0
						THEN total
						ELSE 0 
	...
	group by id,fullname
     ...
     SET out_total_paid = (
			SELECT sum(paid) FROM temp_report_bystaff
		);
	SET out_total_debts = (
			SELECT sum(debts) FROM temp_report_bystaff
		);
	SET out_total_money = (
			SELECT sum(totalMoney) FROM temp_report_bystaff
		);
    SET out_total_profit = (
			SELECT sum(profit) FROM temp_report_bystaff 
		);
	SET out_row_count = (SELECT COUNT(*) FROM temp_report_bystaff);
    
	SELECT	*
		FROM (
			SELECT  
			*, (@row_number := @row_number + 1) AS rownum FROM temp_report_bystaff
            order by temp_report_bystaff.fullname asc
		) t
		WHERE t.rownum >= start_page and t.rownum <= end_page  ;
		
    
    drop TEMPORARY table temp_report_bystaff;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_med_report_places_bySupplier` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `sp_med_report_places_bySupplier`(
	in in_lstSuppliersid nvarchar(4000),
	in in_dtfrom datetime,
    in in_dtto datetime,
	in in_pageindex INT,
	in in_pagesize INT,
...
BEGIN
    ...
    drop TEMPORARY TABLE if exists t_bySuppilersID;
	create TEMPORARY TABLE t_bySuppilersID( txt text );
	insert into t_bySuppilersID values(in_lstSuppliersid);
    
    drop temporary table if exists temp_BySuppliersid;
	create temporary table temp_BySuppliersid( val nvarchar(50) );
	set @sql = concat("insert into temp_BySuppliersid (val) values ('", replace(( select group_concat(distinct txt) as data from t_bySuppilersID), ",", "'),('"),"');");
	prepare stmt1 from @sql;
	execute stmt1;
	select distinct(val) from temp_BySuppliersid;
    
		if(in_lstSuppliersid ='0')
		then
			DROP TEMPORARY TABLE IF EXISTS temp_supplier;
			CREATE TEMPORARY TABLE temp_supplier
			(
			select 
				supplier.id,supplier.name,((issue_detail.price*issue_receipt_detail.quantites)-issue_detail.discounts) as total,issues.debit,
				(((issue_detail.price*issue_receipt_detail.quantites)-issue_detail.discounts)-
					(
					issue_receipt_detail.quantites*(case when issue_detail.is_retail =false
                    then receipt_detail.price
                    else ROUND(receipt_detail.quantities_received*receipt_detail.price/receipt_detail.retail_quantities,0) end
					)
                )
            ...
            inner join med_goods_issue_receipt_detail as issue_receipt_detail on issue_receipt_detail.goods_issue_detail_id=issue_detail.id
            inner join med_goods_receipt_detail as receipt_detail on receipt_detail.id = issue_receipt_detail.goods_receipt_detail_id
            inner join med_goods_receipts as receipts on receipts.id = receipt_detail.goods_receipts_id
			inner join med_suppliers as supplier on supplier.id = receipts.suppliers_id
			where date_format(issues.issue_date,'%Y%m%d') >= date_format(in_dtfrom,'%Y%m%d') 
			and date_format(issues.issue_date,'%Y%m%d') <= date_format(in_dtto,'%Y%m%d')
			 -- and exists(select * from temp_BySuppliersid where temp_BySuppliersid.val=issues.customers_id)
			);
		else
		 DROP TEMPORARY TABLE IF EXISTS temp_supplier;
		CREATE TEMPORARY TABLE temp_supplier
		(
			select 
				supplier.id,supplier.name,((issue_detail.price*issue_detail.quantities)-issue_detail.discounts) as total,issues.debit,
				(((issue_detail.price*issue_detail.quantities)-issue_detail.discounts)-
					(
					issue_detail.quantities*(case when issue_detail.is_retail =false
                    then receipt_detail.price
			...
			where date_format(issues.issue_date,'%Y%m%d') >= date_format(in_dtfrom,'%Y%m%d') 
			and date_format(issues.issue_date,'%Y%m%d') <= date_format(in_dtto,'%Y%m%d')
			and exists(select * from temp_BySuppliersid where temp_BySuppliersid.val=receipts.suppliers_id)
			);
    end if;
   
	
    DROP TEMPORARY TABLE IF EXISTS temp_report_bySupplier;
	CREATE TEMPORARY TABLE temp_report_bySupplier
	(
	select id,name,COALESCE(SUM(
					CASE 
						WHEN debit=0
	...
	group by id,name
     ...
     SET out_total_paid = (
			SELECT sum(paid) FROM temp_report_bySupplier
		);
	SET out_total_debts = (
			SELECT sum(debts) FROM temp_report_bySupplier
		);
	SET out_total_money = (
			SELECT sum(totalMoney) FROM temp_report_bySupplier
		);
    SET out_total_profit = (
			SELECT sum(profit) FROM temp_report_bySupplier 
		);
	SET out_row_count = (SELECT COUNT(*) FROM temp_report_bySupplier);
    
	SELECT	*
		FROM (
			SELECT  
			*, (@row_number := @row_number + 1) AS rownum FROM temp_report_bySupplier
            order by temp_report_bySupplier.name asc
		) t
		WHERE t.rownum >= start_page and t.rownum <= end_page  ;
		
    
    drop TEMPORARY table temp_report_bySupplier;
	drop TEMPORARY table temp_supplier;
	drop temporary table t_bySuppilersID;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_med_report_revenue_byPlaceid` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `sp_med_report_revenue_byPlaceid`(
	in in_placeid bigint,
	in in_dtfrom datetime,
    in in_dtto datetime,
	in in_pageindex INT,
	in in_pagesize INT,
	out out_totalValueReceipt bigint,
	out out_revenueTotal bigint,
	out out_revenueTotalInventory bigint,
    out out_revenueTotalDebit bigint,
	out out_revenueTotalDebitSupplier bigint,
	out out_revenueTotalprofit bigint,
	out out_row_count bigint
)
BEGIN
    DECLARE start_page, end_page INT DEFAULT 0;
	...
	DROP TEMPORARY TABLE IF EXISTS temp_places_1;
	CREATE TEMPORARY TABLE temp_places_1
	(
		select date_format(issues.issue_date,'%d-%m-%Y')as createdate,
	sum((issue_detail.price*issue_detail.quantities)-issue_detail.discounts) as 'revenueTotal',
                 sum(
						case when issues.debit = true 
							then issue_detail.price*issue_detail.quantities
							else 0 end
					) as 'revenueTotalDebit'
                ,
              sum(((issue_detail.price*issue_detail.quantities)-issue_detail.discounts)-
					(
					issue_detail.quantities*(case when issue_detail.is_retail =false
						then receipt_detail.price
						else ROUND(receipt_detail.quantities_received*receipt_detail.price/receipt_detail.retail_quantities,0) end
            ...
            where date_format(issues.issue_date,'%Y%m%d') >= date_format(in_dtfrom,'%Y%m%d') 
			and date_format(issues.issue_date,'%Y%m%d') <= date_format(in_dtto,'%Y%m%d') 
            and issues.places_id= in_placeid
            group by date_format(issues.issue_date,'%d-%m-%Y')
            
	);
	DROP TEMPORARY TABLE IF EXISTS temp_places_2;
	CREATE TEMPORARY TABLE temp_places_2
	(
		  select date_format(receipts.date_receipt,'%d-%m-%Y') as createdate
          ,sum(receipt_detail.quantities_received*receipt_detail.price) as 'totalValueReceipt',
           sum(round(((receipt_detail.quantities_in_stock/round(receipt_detail.retail_quantities/receipt_detail.quantities_received,0))
            *receipt_detail.price),0)) as 'revenueTotalInventory',
            sum(
				case when receipts.debit = true 
					then receipt_detail.quantities_received*receipt_detail.price
                    else 0 end
            ) as 'revenueTotalDebitSupplier'
            
            from med_goods_receipts as receipts
             inner join med_goods_receipt_detail as receipt_detail on receipt_detail.goods_receipts_id = receipts.id
			where date_format(receipts.date_receipt,'%Y%m%d') >= date_format(in_dtfrom,'%Y%m%d') 
			and date_format(receipts.date_receipt,'%Y%m%d') <= date_format(in_dtto,'%Y%m%d') 
            and receipts.places_id= in_placeid
			group by date_format(receipts.date_receipt,'%d-%m-%Y')
      
    );
    
    DROP TEMPORARY TABLE IF EXISTS temp_report_byPlace;
	CREATE TEMPORARY TABLE temp_report_byPlace
	(
		select t.createdate,ifnull(temp_places_2.totalValueReceipt,0) as totalValueReceipt,
        ifnull(temp_places_1.revenueTotal,0) as revenueTotal,
        ifnull(temp_places_2.revenueTotalInventory,0) as revenueTotalInventory,
        ifnull(temp_places_1.revenueTotalDebit,0) as revenueTotalDebit,
        ifnull(temp_places_2.revenueTotalDebitSupplier,0) as revenueTotalDebitSupplier,
        ifnull(temp_places_1.revenueTotalprofit,0) as revenueTotalprofit
        from (
			SELECT  date_format(date_field,'%d-%m-%Y') as createdate
				FROM
				(
				SELECT
						MAKEDATE(YEAR(NOW()),1) +
				...
				where date_format(in_dtfrom,'%Y-%m-%d') <=  date_field
				and date_format(in_dtto,'%Y-%m-%d') >= date_field
                order by  date_field desc
			)t
            left outer join temp_places_2 on t.createdate=temp_places_2.createdate
           left outer join temp_places_1 on t.createdate=temp_places_1.createdate
          
            
    );
     SET out_totalValueReceipt = (
			SELECT sum(ifnull(totalValueReceipt,0)) FROM temp_report_byPlace
		);
	SET out_revenueTotal = (
			SELECT sum(ifnull(revenueTotal,0)) FROM temp_report_byPlace
		);
	SET out_revenueTotalInventory = (
			SELECT sum(ifnull(revenueTotalInventory,0)) FROM temp_report_byPlace
		);
    SET out_revenueTotalDebit = (
			SELECT sum(ifnull(revenueTotalDebit,0)) FROM temp_report_byPlace 
		);
    SET out_revenueTotalDebitSupplier = (
			SELECT sum(ifnull(revenueTotalDebitSupplier,0)) FROM temp_report_byPlace 
		);
    SET out_revenueTotalprofit = (
			SELECT sum(ifnull(revenueTotalprofit,0)) FROM temp_report_byPlace 
		);
	SET out_row_count = (SELECT COUNT(*) FROM temp_report_byPlace);
    
	SELECT	*
		FROM (
			SELECT  
			*, (@row_number := @row_number + 1) AS rownum FROM temp_report_byPlace
              order by STR_TO_DATE(createdate,'%d-%m-%Y') desc
		) t
		WHERE t.rownum >= start_page and t.rownum <= end_page  
        ;
		
    
		-- drop TEMPORARY table temp_report_byPlace;
		-- drop TEMPORARY table temp_places_1;
    	-- drop TEMPORARY table temp_places_2;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_med_report_revenue_detail_byPlaceid` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `sp_med_report_revenue_detail_byPlaceid`(
	in in_placeid bigint,
	in in_dtfrom datetime,
    in in_dtto datetime,
	in in_pageindex INT,
	in in_pagesize INT,
	out out_total_discounts bigint,
	out out_total_totalMoney bigint,
	out out_total_profit bigint,
	out out_row_count bigint
)
BEGIN
...
DROP TEMPORARY TABLE IF EXISTS temp_revenue_detail_byPlaceid;
CREATE TEMPORARY TABLE temp_revenue_detail_byPlaceid
(
	select u.name as customerName,issues.issue_code as issueCode,
		medicines.barcode
		,medicines.name as medicineName,
        issue_detail.quantities,
        issue_detail.price,units.name as unitName,
        ifnull(issue_detail.discounts,0) as discounts,
		((issue_detail.price*issue_detail.quantities)-issue_detail.discounts) as totalMoney,
        (((issue_detail.price*issue_detail.quantities)-issue_detail.discounts)-
					(
					issue_detail.quantities*(case when issue_detail.is_retail =false
                    then receipt_detail.price
                ...
                as 'profit',issues.debit

		  from med_goods_issues as issues
		inner join med_goods_issue_detail as issue_detail on issue_detail.goods_issues_id =  issues.id
		inner join med_customers as u on u.id = issues.customers_id
		inner join med_medicines as medicines on medicines.id=issue_detail.medicines_id
		inner join med_units as units on units.id= issue_detail.units_id
		inner join med_goods_issue_receipt_detail as issue_receipt_detail on issue_receipt_detail.goods_issue_detail_id=issue_detail.id
		inner join med_goods_receipt_detail as receipt_detail on receipt_detail.id = issue_receipt_detail.goods_receipt_detail_id
    ...
    and issues.places_id = in_placeid
     ...
     SET out_total_discounts = (
			SELECT sum(ifnull(discounts,0)) FROM temp_revenue_detail_byPlaceid
		);
	SET out_total_totalMoney = (
			SELECT sum(ifnull(totalMoney,0)) FROM temp_revenue_detail_byPlaceid
		);
	SET out_total_profit = (
			SELECT sum(ifnull(profit,0)) FROM temp_revenue_detail_byPlaceid
		);
	SET out_row_count = (SELECT COUNT(*) FROM temp_revenue_detail_byPlaceid);
    
	SELECT	*
		FROM (
			SELECT  
			*, (@row_number := @row_number + 1) AS rownum FROM temp_revenue_detail_byPlaceid
		) t
		WHERE t.rownum >= start_page and t.rownum <= end_page  ;
		
    
    drop TEMPORARY table temp_revenue_detail_byPlaceid;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `tblRoleDetail_GetAllByUser_NewCms` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `tblRoleDetail_GetAllByUser_NewCms`(
	UserID int,
	GroupUserID bigint,
	SiteID bigint,
...
BEGIN	
	if(UserID > 0 and GroupUserID > 0 and SiteID > 0) then
		SELECT CONCAT(t1.id,'-',UserID) as id,
				UserID as UserId,
				t1.id as MenuId, 
				t1.name as MenuName,
				...
				t1.SiteName,
			t1.RoleId,
-- 			(case when t2.is_view is null then t1.IsView else t2.is_view end) IsView,
-- 			(case when t2.is_new is null then t1.IsInsert else t2.is_new end) IsInsert,
-- 			(case when t2.is_update is null then t1.IsUpdate else t2.is_update end) IsUpdate,
-- 			(case when t2.is_delete is null then t1.IsDelete else t2.is_delete end) IsDelete
			(case when t2.is_view is null then false else t2.is_view end) IsView,
			(case when t2.is_new is null then false else t2.is_new end) IsInsert,
			(case when t2.is_update is null then false else t2.is_update end) IsUpdate,
			(case when t2.is_delete is null then false else t2.is_delete end) IsDelete
		FROM (
			SELECT tc.id, tc.parent_id, tc.name, tc.sites_id,
				IFNULL((select name from sites where sites.id=tc.sites_id),'')SiteName,
				IFNULL((select id from roles where roles.users_id=UserID and roles.menus_id=tc.id),0)RoleId,
				IFNULL((select is_delete from roles where roles.users_id=UserID and roles.menus_id=tc.id),false)IsDelete,
				IFNULL((select is_update from roles where roles.users_id=UserID and roles.menus_id=tc.id),false)IsUpdate,
				IFNULL((select is_new from roles where roles.users_id=UserID and roles.menus_id=tc.id),false)IsInsert,
				IFNULL((select is_view from roles where roles.users_id=UserID and roles.menus_id=tc.id),false)IsView
			FROM menus tc
			WHERE tc.status = 1 and tc.name like CONCAT('%',categoryName,'%') COLLATE utf8_general_ci
		)t1 left join (
			SELECT * from roles_templates rt
			WHERE rt.groups_users_id = GroupUserID and rt.sites_id = SiteID
		) t2
		on t1.id=t2.menus_id
		ORDER BY t1.parent_id ASC, t1.id ASC;
	elseif(UserID > 0 and GroupUserID < 0 and SiteID < 0) then
		SELECT CONCAT(t1.id,'-',UserID) as id,
				UserID as UserId,
				t1.id as MenuId, 
				t1.name as MenuName,
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `tblRoleDetail_Update_NewCms` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `tblRoleDetail_Update_NewCms`(json JSON, userId BIGINT)
BEGIN
	DECLARE json_items_length BIGINT UNSIGNED DEFAULT JSON_LENGTH(json);
  DECLARE _index BIGINT UNSIGNED DEFAULT 0;
	
	DECLARE _IsDelete TINYINT(1) default false;
	DECLARE _IsUpdate TINYINT(1) default false;
	DECLARE _IsInsert TINYINT(1) default false;
	DECLARE _IsView TINYINT(1) default false;
	DECLARE _IsStatus TINYINT(1) default false;
	DECLARE _UserId BIGINT UNSIGNED DEFAULT 0;
	DECLARE _MenuId BIGINT UNSIGNED DEFAULT 0;
	DECLARE _SiteId BIGINT UNSIGNED DEFAULT 0;
	DECLARE _RoleId BIGINT UNSIGNED DEFAULT 0;

  WHILE _index < json_items_length DO

		set _IsInsert := (JSON_EXTRACT(json, CONCAT('$[', _index, '].IsInsert')));
		set _IsView := (JSON_EXTRACT(json, CONCAT('$[', _index, '].IsView')));
		set _IsUpdate := (JSON_EXTRACT(json, CONCAT('$[', _index, '].IsUpdate')));
		set _IsDelete := (JSON_EXTRACT(json, CONCAT('$[', _index, '].IsDelete')));
		set _SiteId := (JSON_EXTRACT(json, CONCAT('$[', _index, '].SiteId')));
		set _UserId := JSON_EXTRACT(json, CONCAT('$[', _index, '].UserId'));
		set _MenuId := JSON_EXTRACT(json, CONCAT('$[', _index, '].MenuId'));
		set _RoleId := JSON_EXTRACT(json, CONCAT('$[', _index, '].RoleId'));

		
		if(_RoleId = 0) then
			INSERT INTO `roles`(`is_new`, `is_view`, `is_update`, `is_delete`, `users_id`, `sites_id`, `menus_id`)
			VALUES (_IsInsert, _IsView, _IsUpdate, _IsDelete, _UserId, _SiteId, _MenuId);
		else
			UPDATE roles
			SET roles.is_new = _IsInsert,
				roles.is_update = _IsUpdate,
				roles.is_delete = _IsDelete,
				roles.is_view = _IsView
-- 				Roles.IsStatus = _IsStatus
			WHERE roles.id = _RoleId;
		end if;
		
    SET _index := _index + 1;
  END WHILE;
	select * from roles where users_id = userId;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `tblroleTemplateDetail_GetAllByUser_NewCms` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `tblroleTemplateDetail_GetAllByUser_NewCms`(
	GroupUserID bigint,
	SiteID bigint, 
	categoryName varchar(50)
)
BEGIN	
	if(GroupUserID > 0) then
		SELECT CONCAT(t1.id,'-',GroupUserID) as id,
			...
			t1.RoleId,
			t1.IsView as IsView,
			t1.IsInsert as IsInsert,
			t1.IsUpdate as IsUpdate,
			t1.IsDelete as IsDelete
		FROM (
			SELECT tc.id, tc.parent_id, tc.name, tc.sites_id,
				IFNULL((select name from group_users where group_users.id=GroupUserID),'')GroupUserName,
				IFNULL((select name from sites where sites.id=tc.sites_id),'')SiteName,
				IFNULL((select id from roles_templates where roles_templates.groups_users_id=GroupUserID and roles_templates.menus_id=tc.id),0)RoleId,
				IFNULL((select is_delete from roles_templates where roles_templates.groups_users_id=GroupUserID and roles_templates.menus_id=tc.id),false)IsDelete,
				IFNULL((select is_update from roles_templates where roles_templates.groups_users_id=GroupUserID and roles_templates.menus_id=tc.id),false)IsUpdate,
				IFNULL((select is_new from roles_templates where roles_templates.groups_users_id=GroupUserID and roles_templates.menus_id=tc.id),false)IsInsert,
				IFNULL((select is_view from roles_templates where roles_templates.groups_users_id=GroupUserID and roles_templates.menus_id=tc.id),false)IsView
			FROM menus tc
			WHERE tc.status = 1 
				and tc.name like CONCAT('%',categoryName,'%') COLLATE utf8_general_ci
				and tc.sites_id = (case when SiteID = -1 then tc.sites_id else SiteID end)
		)t1
		ORDER BY t1.parent_id ASC, t1.id ASC;
	else
		select * from menus where 1 != 1;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `tblroleTemplateDetail_Update_NewCms` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `tblroleTemplateDetail_Update_NewCms`(json JSON, groupUserId BIGINT)
BEGIN
	DECLARE json_items_length BIGINT UNSIGNED DEFAULT JSON_LENGTH(json);
  DECLARE _index BIGINT UNSIGNED DEFAULT 0;
  ...
  WHILE _index < json_items_length DO
		...
		set _IsDelete := (JSON_EXTRACT(json, CONCAT('$[', _index, '].IsDelete')));
		set _SiteId := (JSON_EXTRACT(json, CONCAT('$[', _index, '].SiteId')));
		set _UserId := JSON_EXTRACT(json, CONCAT('$[', _index, '].GroupUserId'));
		set _MenuId := JSON_EXTRACT(json, CONCAT('$[', _index, '].MenuId'));
		set _RoleId := JSON_EXTRACT(json, CONCAT('$[', _index, '].RoleId'));

		
		if(_RoleId = 0) then
			INSERT INTO `roles_templates`(`is_new`, `is_view`, `is_update`, `is_delete`, `groups_users_id`, `sites_id`, `menus_id`)
			VALUES (_IsInsert, _IsView, _IsUpdate, _IsDelete, _UserId, _SiteId, _MenuId);
		else
			UPDATE roles_templates
			SET roles_templates.is_new = _IsInsert,
				roles_templates.is_update = _IsUpdate,
				roles_templates.is_delete = _IsDelete,
				roles_templates.is_view = _IsView
-- 				Roles.IsStatus = _IsStatus
			WHERE roles_templates.id = _RoleId;
		end if;
		
    SET _index := _index + 1;
  END WHILE;
	select * from roles_templates where groups_users_id = groupUserId;
...
BEGIN
if ifnull((select if(quantities_in_stock <100,1,0)
from med_goods_receipt_detail where id=0),0) = 1
then 
 select 0;
else 
	select 1;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `update_places_users` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `update_places_users`(in in_users_id VARCHAR(20), in in_users_creator_id VARCHAR(20), in in_lst_places VARCHAR(255))
BEGIN
  #Routine body goes here...
	DECLARE lst_places VARCHAR(255);
	...
	START TRANSACTION;
	IF in_lst_places != '' THEN
		drop TEMPORARY table if exists tmp_places;
		create TEMPORARY table tmp_places
			SELECT id as placesId FROM places WHERE FIND_IN_SET(id, in_lst_places);
			
		SET lst_places = ( select group_concat(distinct placesId) as data from tmp_places);
		IF NOT ISNULL(lst_places)
		THEN
			DELETE FROM places_users WHERE users_id = in_users_id;
			set @sql = concat("insert into places_users (places_id, users_id, users_creator_id, status) values (", replace(lst_places, ",", concat(",", in_users_id, ",", in_users_creator_id, ",1","),(")), ",", in_users_id, ",", in_users_creator_id, ",1",");");
			prepare stmt1 from @sql;
			execute stmt1;
			SELECT 1 as status;
...
-- Dump completed on 2019-10-14 15:36:35
